...
function Login() {
  const navigate = useNavigate();
    ...
    const handleSubmit = (values: { username: string, firstname: string, lastname: string, password: string }) => {
    ...
    const validate = (values: { username: string, firstname: string, lastname: string, password: string }) => {
        const errors: { username?: string, firstname?: string, lastname?: string, password?: string } = {};
        if (!values.username) {
        ...
        if (values.username !== sanitize_username_input(values.username)) {
            errors.username = "Mauvais nom d'utilisateur : ne doit contenir que des lettres minuscules et des chiffres";
        }
        return errors;
    };
