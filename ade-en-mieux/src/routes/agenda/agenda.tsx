        ...
        <div className="main-container">
          ...
          <div className="main-content">
            ...
            <div className="week-navigation">
              <button className="button-64" id="previous-week">
                <span className="text">Semaine précédente</span>
              </button>
              <span id="current-week"></span>
              <button className="button-64" id="next-week">
                <span className="text">Semaine suivante</span>
              </button>
            </div>
